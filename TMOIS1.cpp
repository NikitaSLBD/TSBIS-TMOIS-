...
void main() // Главная функция
{
    ...
    int m_A, m_B, par1, par2, ord; // Декларация переменных
    ...
    printf("\nВыберите способ задания множеств (1:Перечисление; 2:Высказывание): "); // Вывод инструкции для пользователя
    ...
    for (int i = 0; i < m_A; i++)
    {
        if (par2 == 1) // Проверка на то, какой способ задания множества выбрал пользователь
        {
            ...
            A[i] = 3 * (i + 1) + 1; // Заносим значение выражения в переменную A[i]
    }
    ...
    for (int j = 0; j < m_B; j++)
    {
        if (par2 == 1) // Проверка на то, какой способ задания множества выбрал пользователь
        {
            ...
            B[j] = 2 * (j + 1) + 3; // Заносим значение выражения в переменную B[j]
    }
